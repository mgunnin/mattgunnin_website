...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'about', 'resume', 'projects', 'resources', 'contact'];
  ...
  return (
    <main className="min-h-screen bg-cyber-black text-gray-200 selection:bg-cyber-primary selection:text-black font-sans overflow-x-hidden">
      <Background />
      ...
      <footer className="py-12 text-center text-gray-600 text-sm border-t border-gray-900 bg-black relative z-10">
        <div className="flex justify-center gap-6 mb-4">
          <a href="#" className="hover:text-cyber-primary transition-colors">LinkedIn</a>
          <a href="#" className="hover:text-cyber-primary transition-colors">GitHub</a>
